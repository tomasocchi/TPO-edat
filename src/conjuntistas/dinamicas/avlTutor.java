...
public class avlTutor {
    ...
    private boolean insertarAuxInsertarHijos(NodoAVL padre, NodoAVL subRaiz, char hijo, Comparable elemento){
        ...
        if(subRaiz != null){
            if(!subRaiz.getElem().equals(elemento)){
                if(subRaiz.getElem().compareTo(elemento) > 0){
    ...
    private NodoAVL metodo3(NodoAVL nodo){
        ...
        if(hijosCandidatoA <= hijosCandidatoB){
            ...
            nodo.setElem(candidatoA.getElem());
            //eliminamos el elemento de candidato a por I
            complatado = eliminarAux(nodo, nodo.getIzquierdo(), candidatoA.getElem(), 'I');
        }else{
            //obtenemos el valor de este nodo y eliminamos por ese lado
            nodo.setElem(candidatoB.getElem());
            //eliminamos el elemento de candidato a por D
            complatado = eliminarAux(nodo, nodo.getDerecho(), candidatoB.getElem(), 'D');
        }
        if(complatado){
            retorno = nodo;
        }
    ...
    private NodoAVL dobleIzquierdaDerecha(NodoAVL padre){
        ...
        System.out.println("El nuevo hijo Izquierdo "+hijoIzqueirdo.getElem().toString());
        padre.setIzquierdo(hijoIzqueirdo);
        //hacemos rotar hacia la derecha a el padre
        NodoAVL nuevoPadre = giroDerecha(padre);
        System.out.println("El nuevo padre: "+nuevoPadre.getElem().toString());
    ...
    private void listaAux(NodoAVL subRaiz, Lista retorno){
        ...
        if(subRaiz != null){
            ...
            retorno.insertar(subRaiz.getElem(), retorno.longitud() + 1);
    ...
    private void listaRangoAuz(NodoAVL subRaiz, Lista retorno, Comparable minimo, Comparable maximo){
        ...
        if(subRaiz.getElem().compareTo(minimo) >= 0 && subRaiz.getElem().compareTo(maximo) <= 0){
            ...
            if(subRaiz.getDerecho() != null && subRaiz.getElem().compareTo(minimo) < 0){
                ...
                if(subRaiz.getIzquierdo() != null && subRaiz.getElem().compareTo(maximo) > 0){
                    listaRangoAuz(subRaiz.getIzquierdo(), retorno, minimo, maximo);
                }
            }
        }
    ...
    public Comparable minimoElem(){
        ...
        if(this.raiz != null){
            minimo = candidatoB(this.raiz).getElem();
        }
        return minimo;
    }
    ...
    public Comparable maximoElem(){
        Comparable minimo = null;
        if(this.raiz != null){
            minimo = candidatoA(this.raiz).getElem();
        }
        return minimo;
    }
     ...
     * @return 
     */
    public avlTutor clone(){
        avlTutor clon = new avlTutor();
        
        if(this.raiz != null){
            clon.raiz = new NodoAVL(this.raiz.getElem(), null, null);
    ...
    private void cloneAux(NodoAVL subRaiz, NodoAVL subRaizClone){
        if(subRaiz != null){
            if(subRaiz.getIzquierdo() != null){
                ...
                subRaizClone.setIzquierdo(new NodoAVL(subRaiz.getIzquierdo().getElem(), null, null));
            ...
            if(subRaiz.getDerecho() != null){
                ...
                subRaizClone.setDerecho(new NodoAVL(subRaiz.getDerecho().getElem(), null, null));
                //hacemos el llamado recursivo
