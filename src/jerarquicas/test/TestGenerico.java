...
public class TestGenerico {
    ...
    public static void main(String args[]) {
      ...
      //  System.out.println("Grado de subarbol con raiz 9: Tiene que dar 2: " + sOk + " --> " + (((int) a.grado()) == 2) ? sOk : sErr));
        System.out.println("Grado de subarbol con raiz 15: Tiene que dar 4: " + sOk + " --> " + (((int) a.grado() == 4) ? sOk : sErr));
        System.out.println("Grado de subarbol con raiz 30: Tiene que dar 3: " + sOk + " --> " + (((int) a.grado() == 3) ? sOk : sErr));
        System.out.println("Grado de subarbol con raiz 45: Tiene que dar 0: " + sOk + " --> " + (((int) a.grado() == 0) ? sOk : sErr));
        System.out.println("Grado de subarbol con raiz inexistente 90: Tiene que dar -1: " + sOk + " --> " + (((int) a.grado() == -1) ? sOk : sErr));
